...
def run_popoolation_prep(biallelic_fish_maf, maf_filename):
    ...
    sync_fish.to_csv(f'PoPoolation/prepared_inputs/{output_filename}', header=False, index=False, sep=" ")
    print(f'{output_filename} created in PoPoolation/prepared_inputs folder\n')
